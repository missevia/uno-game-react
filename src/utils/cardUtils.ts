...
export const checkValidCard = (
	...
	return (
	  (isWild && activeSpecialCard === null) ||
	  (topDiscard.value === CardValue.Wild) ||
	  (isWildDrawFour && noActiveDrawCards && !hasPlayableCard) ||
	  (activeSpecialCard === CardValue.DrawTwo && card.value === CardValue.DrawTwo) ||
	  (activeSpecialCard !== CardValue.Skip && topDiscard.value === CardValue.WildDrawFour && activeSpecialCard !== CardValue.WildDrawFour) ||
	  (activeSpecialCard !== CardValue.Skip && activeSpecialCard !== CardValue.DrawTwo && (isSameColor || isSameValue))
	);
};